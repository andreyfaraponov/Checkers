...
//
//		public HardBotController(BoardController boardControllerController, List<PositionPoint> points, BoardController boardControllerReference = null) 
//			: base(boardControllerController, points, boardControllerReference)
//		{
//		}
//
//		protected override async UniTask MakeMoveAsync()
//		{
//			_possibleMoves.Clear();
//
//			_currentBoard = BoardController.CurrentBoard.Clone() as int[,];
//
...
//			await UniTask.Delay(500);
//
//			CurrentTurnCompletionSource.TrySetResult();
//		}
//
//		/// <summary>
...
//			return CheckersBasics.GetAvailableAttacksDictionary(Board, figurePosition).Values.ToList();
//		}
//
//		/// <summary>
...
//			{
//				int rowsToKing = to.Y;
//				score += KING_ROW_PROXIMITY * (BoardController.BoardSize - rowsToKing) / (float)BoardController.BoardSize;
//			}
//
//			// Check if move leaves piece vulnerable
//			score += EvaluateVulnerability(to, figure);
...
//			int rowsFromStart = BoardController.BoardSize - 1 - position.Y;
...
//				{
//					var opponentPos = Board[opponentX, opponentY];
//					if (opponentPos?.Figure != null && !opponentPos.Figure.IsBlack)
//					{
//						var checkPos = Board[checkX, checkY];
//						
...
//				{
//					var targetPos = Board[targetX, targetY];
//					var landingPos = Board[landingX, landingY];
//
...
//		{
//			return position.X == 0 || position.X == BoardController.BoardSize - 1 ||
//			       position.Y == 0 || position.Y == BoardController.BoardSize - 1;
//		}
//
//		/// <summary>
...
//		{
//			return x >= 0 && x < BoardController.BoardSize && y >= 0 && y < BoardController.BoardSize;
//		}
//
//		/// <summary>
...
//			// Execute the highest scoring move
//			var bestMove = scoredMoves[0];
//			ExecuteSimpleMoveAsync(bestMove.From, bestMove.To);
//
