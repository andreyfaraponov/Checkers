...
//
//		public MediumBotController(PositionPoint[,] boardView, List<PositionPoint> points, BoardController boardControllerReference = null) 
//			: base(boardView, points, boardControllerReference)
//		{
//		}
//
